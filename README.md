...
Just perform the following commands for a full install, including all optional dependencies:
    ...
    apt-get install python-setuptools xmount ewf-tools afflib-tools sleuthkit lvm2 mdadm cryptsetup libmagic avfs disktype losetup squashfs-tools mtd-tools
